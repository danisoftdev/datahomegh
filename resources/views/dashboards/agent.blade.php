...
@section('title', __('Agent dashboard') . ' — ' . config('app.name'))

@section('content')
    <div class="w-full max-w-lg rounded-2xl border border-white/10 bg-[#16213E]/80 p-8 text-center shadow-xl backdrop-blur-sm">
        <h1 class="mb-2 text-xl font-bold text-white">{{ __('Agent dashboard') }}</h1>
        <p class="mb-6 text-slate-400">{{ __('Placeholder — build your agent experience here.') }}</p>
